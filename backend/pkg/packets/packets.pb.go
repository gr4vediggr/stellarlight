...
func (x *Packet) GetSender() uint64 {
	if x != nil {
		return x.Sender
	}
	return 0
...
func (x *Packet) GetChatMessage() *ChatMessage {
	if x != nil {
		if x, ok := x.Payload.(*Packet_ChatMessage); ok {
...
func (x *Packet) GetIdMessage() *IdMessage {
	if x != nil {
		if x, ok := x.Payload.(*Packet_IdMessage); ok {
			return x.IdMessage
		}
	}
	return nil
...
type Packet_IdMessage struct {
	IdMessage *IdMessage `protobuf:"bytes,3,opt,name=id_message,json=idMessage,proto3,oneof"`
}

func (*Packet_ChatMessage) isPacket_Payload() {}

func (*Packet_IdMessage) isPacket_Payload() {}
...
const file_packets_proto_rawDesc = "" +
	"\n" +
	"\rpackets.proto\x12\apackets\"\x9b\x01\n" +
	"\x06Packet\x12\x16\n" +
	"\x06sender\x18\x01 \x01(\x04R\x06sender\x129\n" +
	"\fchat_message\x18\x02 \x01(\v2\x14.packets.ChatMessageH\x00R\vchatMessage\x123\n" +
	"\n" +
	"id_message\x18\x03 \x01(\v2\x12.packets.IdMessageH\x00R\tidMessageB\t\n" +
	"\apayload\"?\n" +
	"\vChatMessage\x12\x18\n" +
	"\acontent\x18\x01 \x01(\tR\acontent\x12\x16\n" +
	"\x06sender\x18\x02 \x01(\tR\x06sender\"\x1b\n" +
	"\tIdMessage\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x04R\x02idB\rZ\vpkg/packetsb\x06proto3"
...
var file_packets_proto_depIdxs = []int32{
	1, // 0: packets.Packet.chat_message:type_name -> packets.ChatMessage
	2, // 1: packets.Packet.id_message:type_name -> packets.IdMessage
